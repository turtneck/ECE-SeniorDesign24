...
static const _PtpStatus_type_support_symbol_names_t _PtpStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multisense_msgs, msg, PtpStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, multisense_msgs, msg, PtpStatus)),
  }
};
...
{
  return &::multisense_msgs::msg::rosidl_typesupport_cpp::PtpStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, multisense_msgs, msg, PtpStatus)() {
  return get_message_type_support_handle<multisense_msgs::msg::PtpStatus>();
}
