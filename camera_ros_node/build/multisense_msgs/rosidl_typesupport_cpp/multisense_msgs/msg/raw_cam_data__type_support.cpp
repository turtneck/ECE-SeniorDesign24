...
static const _RawCamData_type_support_symbol_names_t _RawCamData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multisense_msgs, msg, RawCamData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, multisense_msgs, msg, RawCamData)),
  }
};
...
{
  return &::multisense_msgs::msg::rosidl_typesupport_cpp::RawCamData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, multisense_msgs, msg, RawCamData)() {
  return get_message_type_support_handle<multisense_msgs::msg::RawCamData>();
}
